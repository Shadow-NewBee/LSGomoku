...
@property (nonatomic,weak) LSChecherboardView * boardView;
...
-(void)setUp
{
    ...
    //添加棋盘
    LSChecherboardView * boardView = [[LSChecherboardView alloc]initWithFrame:CGRectMake(20, 30, ScreenW * 0.95, CGFLOAT_MAX)];
...
{
    [self.boardView backOneStep:sender];
}
